...
func (m *Manager) pickNext(ctx context.Context, provider, model string, opts cliproxyexecutor.Options, tried map[string]struct{}) (*Auth, ProviderExecutor, error) {
	if !m.useSchedulerFastPath() || m.hasRestrictedClientAuthGroups(opts) {
...
func (m *Manager) hasRestrictedClientAuthGroups(opts cliproxyexecutor.Options) bool {
	_, restricted := m.allowedAuthGroupsForClientAPIKey(clientAPIKeyFromMetadata(opts.Metadata))
	return restricted
}
