...
func GetOpenAIModels() []*ModelInfo {
	return []*ModelInfo{
		...
		},
		{
			...
			OwnedBy:             "openai",
			Type:                "openai",
			Version:             "gpt-5.4-pro-2026-03-05",
			DisplayName:         "GPT 5.4 Pro",
			Description:         "Most capable GPT-5.4 variant optimized for highest complexity reasoning and professional workloads.",
			ContextLength:       1050000,
			MaxCompletionTokens: 128000,
			SupportedParameters: []string{"tools"},
			Thinking:            &ThinkingSupport{Levels: []string{"medium", "high", "xhigh"}},
		},
	}
}
